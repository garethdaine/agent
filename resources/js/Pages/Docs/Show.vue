...
const tocItems = computed(() => extractHeadings(bodyMarkdown.value));
                ...
                <div class="grid gap-6 lg:grid-cols-[280px_minmax(0,1fr)_260px]">
                            ...
                            <nav v-else class="space-y-4">
                                ...
                                >
                                    ...
                                    <Link
                                        ...
                                        :class="entry.slug === item.slug ? 'bg-primary/15 text-primary' : 'text-foreground hover:bg-accent/40'"
                                    >
                                        {{ item.title }}
                                    </Link>
                                </section>
                    ...
                    <main class="min-w-0 space-y-4">
                        ...
                        <article class="rounded-xl border border-border/70 bg-background/40 p-6 sm:p-8">
                            ...
                            <h1 class="mt-2 text-3xl font-semibold text-foreground">{{ entry.title }}</h1>
                            <p class="mt-3 text-base text-muted-foreground">{{ entry.summary }}</p>
