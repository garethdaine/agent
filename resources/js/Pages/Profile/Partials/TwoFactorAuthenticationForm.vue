...
<template>
    <ActionSection>
        ...
        <template #content>
            <h3 v-if="twoFactorEnabled && ! confirming" class="text-lg font-medium text-foreground">
                You have enabled two factor authentication.
            </h3>

            <h3 v-else-if="twoFactorEnabled && confirming" class="text-lg font-medium text-foreground">
                Finish enabling two factor authentication.
            </h3>

            <h3 v-else class="text-lg font-medium text-foreground">
            ...
            <div v-if="twoFactorEnabled">
                ...
                <div v-if="recoveryCodes.length > 0 && ! confirming">
                    ...
                    <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-muted text-foreground rounded-lg">
