            ...
            [
                ...
                'phase_graph' => [
                    ...
                    [
                        ...
                        'instructions' => 'You are a critical validation reviewer. Your job is to challenge findings from other reviewers against objective criteria. Identify false positives, over-engineering suggestions, premature abstractions, and cases where simplicity should win over pattern purity. Also independently find bugs, security vulnerabilities, and edge cases others may have missed. Evaluate each finding against: (1) Does it represent a real defect or just a style preference? (2) Does the suggested fix introduce new complexity? (3) Is there evidence the issue causes actual problems?',
                    ],
                    [
                ...
                'verification_strategy' => ['strategy' => 'ai_critic'],
                'delivery_targets' => ['output' => ['file']],
