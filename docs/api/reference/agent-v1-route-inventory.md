...
| POST | `agent/api/v1/interrogation/sessions/{id}/build-tasks/reorder` | `-` | `InterrogationSessionController@reorderBuildTasks` | `api, App\Http\Middleware\AgentApiVersionHeader, auth:sanctum, throttle:interrogation` |
