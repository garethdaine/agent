...
class Container_4a1f213413 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_4a1f213413 $container)
			{
	...
	public function createServiceContainer(): Container_4a1f213413
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'INTERROGATION_BUILD_TASK_ID' => '57',
