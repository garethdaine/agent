...
class Container_bf01033852 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_bf01033852 $container)
			{
	...
	public function createServiceContainer(): Container_bf01033852
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'MallocNanoZone' => '0',
				'CLAUDE_AGENT_SDK_VERSION' => '0.2.63',
				...
				'CLAUDE_CODE_OAUTH_TOKEN' => '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',
				...
				'INTERROGATION_SESSION_ID' => '7',
				'INTERROGATION_BUILD_TASK_ID' => '67',
				'INTERROGATION_DB_ISOLATED' => '1',
				'INTERROGATION_BUILD_DB_PATH' => '/Users/garethdaine/Code/agent/storage/framework/interrogation-build/session-7.sqlite',
