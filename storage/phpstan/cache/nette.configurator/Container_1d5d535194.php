...
class Container_1d5d535194 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_1d5d535194 $container)
			{
	...
	public function createServiceContainer(): Container_1d5d535194
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'_' => '/Users/garethdaine/Library/Application Support/Herd/bin/php84',
				'REDIS_PASSWORD' => 'null',
